                ...
                <div className="subject-card--blue my-catalog__block">
                  <div className="my-catalog__left">
                    ...
                    <p className="my-catalog__left-text">
                      Програма курсу включає в себе вивчення різноманітних аспектів образотворчого мистецтва, від традиційних технік до сучасних течій. Наші викладачі
                      підходять до навчання з креативним підходом, стимулюючи учнів думати творчо та виражати свої ідеї через мистецтво. Високоякісні відеоуроки, які
                      покривають різні аспекти мистецтва та надають можливість долучитися до творчих завдань.
                    </p>
                    ...
                    <div className="my-catalog__contact close">
                      <button className="my-catalog__contact-btn">
                        <svg className="my-catalog__contact-svg">
                          <use href="/img/sprite.svg#arrow-top" />
                        </svg>
                      </button>
                    </div>
                  </div>
                    ...
                    <div className="teacher-card  teacher-card--big lesson-section__card-card">
                      <div className="teacher-card__top">
                        <span className="courses-lesson__span">
                          <svg>
                            <use href="/img/sprite.svg#star-strok" />
                          </svg>
                        </span>
                      ...
                      <button className="teacher-card__question">
                        <svg className="teacher-card__question-svg">
                          <use href="/img/sprite.svg#message" />
                        </svg>
                        Задати питання
                      </button>
                    </div>
                    ...
                    <div className="statistics-block__top">
                      ...
                      >
                        ...
                        <svg className="reviews__arrow-svg reviews__arrow--active">
                          <use href="/img/sprite.svg#arrow-ridth" />
                        </svg>
                      </a>
                    </div>
